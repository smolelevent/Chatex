...
//HÁTTÉR FOLYAMATOK ELEJE -------------------------------------------------------------------------
  ...
  String formatMessageTime(String timestamp, BuildContext context) {
    ...
    try {
      ...
      final difference = now.difference(dateTime); //különbség a mostani idő és a timestamp között
      ...
      return ""; // Itt a hibaágban már jól volt megírva!
    }
  }
  ...
  Widget _buildChatTile(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
          ...
          children: [
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  color: hasUnreadMessages ? Colors.white : Colors.grey[400], //emelje ki az olvasatlan üzenetet
                ),
              ),
            ),
        ...
        trailing: Text(
          formatMessageTime(time, context), //formázzuk az utlolsó üzenet időpontját
          style: TextStyle(
            fontSize: 12,
