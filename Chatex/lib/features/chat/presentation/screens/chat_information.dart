...
//HÁTTÉR FOLYAMATOK ELEJE -------------------------------------------------------------------------
  ...
  Future<void> _deleteChat(BuildContext context) async {
    ...
    try {
      ...
      //   Uri.parse("http://10.0.2.2/ChatexProject/chatex_phps/chat/set/delete_chat.php"),
      ...
      //     Preferences.isHungarian ? "A beszélgetés sikeresen törölve lett!" : "Chat deleted successfully!",
      //     0.2,
      //     Colors.green,
      //     Icons.check_rounded,
      //     Colors.black,
      ...
      //
      //   ToastMessages.showToastMessages(
      //     Preferences.isHungarian ? "Hiba történt a törlés során!" : "Failed to delete chat!",
      //     0.2,
      //     Colors.redAccent,
      //     Icons.error,
      //     Colors.black,
      ...
      ToastMessages.showToastMessages(
        l10n.connectionErrorDeletingChat,
        0.2,
        Colors.redAccent,
        Icons.error,
        Colors.black,
